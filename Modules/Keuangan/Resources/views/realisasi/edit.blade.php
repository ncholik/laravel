        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url(Request::server('HTTP_REFERER') == null ? '/keuangan/realisasi' : Request::server('HTTP_REFERER')) }}"
                    ...
                    <form method="POST" action="{{ route('realisasi.update', $perencanaan->id) }}" accept-charset="UTF-8"
