    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="program" type="text" id="program" value=""
                            required>
                    </div>
                    <div class="col-md-6">
                        <label for="kegiatan" class="control-label">Realisasi</label>
                        <input class="form-control" name="kegiatan" type="text" id="kegiatan" value=""
                            required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <input class="form-control" name="laporan_keuangan" type="text" id="laporan_keuangan" value=""
                    required>
            </div>
            <div class="form-group">
                <label for="laporan_kegiatan" class="control-label">Laporan Kegiatan</label>
                <input class="form-control" name="laporan_kegiatan" type="text" id="laporan_kegiatan" value=""
                    required>
            </div>
            <div class="form-group">
