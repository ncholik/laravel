        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        @include('keuanganmpa::include.dashboard-bulanan.chart_realisasi')
                        @include('keuanganmpa::include.dashboard-bulanan.tabel_progres')
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        @include('keuanganmpa::include.dashboard-bulanan.chart_serapan')
                    </div>
                    <div class="row mt-4">
                        @include('keuanganmpa::include.dashboard-bulanan.tabel_unit')
                    </div>
                </div>
            </div>
        </div>
