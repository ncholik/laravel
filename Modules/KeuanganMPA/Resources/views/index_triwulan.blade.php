        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        @include('keuanganmpa::include.dashboard-triwulan.chart_realisasi_triwulan')
                        @include('keuanganmpa::include.dashboard-triwulan.tabel_progres_triwulan')
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        @include('keuanganmpa::include.dashboard-triwulan.chart_serapan_triwulan')
                    </div>
                    <div class="row mt-4">
                        @include('keuanganmpa::include.dashboard-triwulan.tabel_unit_triwulan')
                    </div>
                </div>
            </div>
        </div>
